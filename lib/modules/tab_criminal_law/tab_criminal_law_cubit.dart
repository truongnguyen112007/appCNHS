...
class TabCriminalLawCubit extends Cubit<TabCriminalLawState> {
  TabCriminalLawCubit() : super(const TabCriminalLawState(status: FeedStatus.initial)) {
  ...
  void refresh() {
    emit(TabCriminalLawState(status: FeedStatus.refresh));
    getFeed();
  }
